...
! function(t, e) { "use strict"; "function" == typeof define && define.amd ? define(e) : "object" == typeof exports ? module.exports = e() : t.baguetteBox = e() }(this, function() {
    ...
    function t(t, e) {
        ...
        D[t] = o, [].forEach.call(n, function(t) {
            ...
            var n = [];
            if (n = "A" === t.tagName ? [t] : t.getElementsByTagName("a"), 0 !== (n = [].filter.call(n, function(t) { if (-1 === t.className.indexOf(e && e.ignoreClass)) return z.test(t.href) })).length) {
                var i = [];
                [].forEach.call(n, function(t, n) {
                    var o = function(t) { t.preventDefault ? t.preventDefault() : t.returnValue = !1, r(i, e), u(n) },
    ...
    function e() { for (var t in D) D.hasOwnProperty(t) && n(t) }

    function n(t) {
        if (D.hasOwnProperty(t)) {
            var e = D[t].galleries;
            [].forEach.call(e, function(t) {
                [].forEach.call(t, function(t) { E(t.imageElement, "click", t.eventHandler) }), X === t && (X = [])
            }), delete D[t]
        }
    }
    ...
    function a() { x(N, "click", W), x(L, "click", G), x(S, "click", J), x(P, "click", K), x(A, "contextmenu", _), x(N, "touchstart", Q), x(N, "touchmove", Z), x(N, "touchend", $), x(document, "focus", tt, !0) }

    function l() { E(N, "click", W), E(L, "click", G), E(S, "click", J), E(P, "click", K), E(A, "contextmenu", _), E(N, "touchstart", Q), E(N, "touchmove", Z), E(N, "touchend", $), E(document, "focus", tt, !0) }
    ...
    function s(t) {
        ...
        try { N.style.backgroundColor = Y.overlayBackgroundColor } catch (n) {}
    }

    function u(t) { Y.noScrollbars && (document.documentElement.style.overflowY = "hidden", document.body.style.overflowY = "scroll"), "block" !== N.style.display && (x(document, "keydown", i), R = { count: 0, startX: null, startY: null }, m(M = t, function() { k(M), C(M) }), y(), N.style.display = "block", Y.fullScreen && d(), setTimeout(function() { N.className = "visible", Y.bodyClass && document.body.classList && document.body.classList.add(Y.bodyClass), Y.afterShow && Y.afterShow() }, 50), Y.onChange && Y.onChange(M, V.length), U = document.activeElement, c()) }

    function c() { Y.buttons ? L.focus() : P.focus() }

    function d() { N.requestFullscreen ? N.requestFullscreen() : N.webkitRequestFullscreen ? N.webkitRequestFullscreen() : N.mozRequestFullScreen && N.mozRequestFullScreen() }

    function f() { document.exitFullscreen ? document.exitFullscreen() : document.mozCancelFullScreen ? document.mozCancelFullScreen() : document.webkitExitFullscreen && document.webkitExitFullscreen() }

    function g() { Y.noScrollbars && (document.documentElement.style.overflowY = "auto", document.body.style.overflowY = "auto"), "none" !== N.style.display && (E(document, "keydown", i), N.className = "", setTimeout(function() { N.style.display = "none", f(), Y.bodyClass && document.body.classList && document.body.classList.remove(Y.bodyClass), Y.afterHide && Y.afterHide(), U && U.focus() }, 500)) }
    ...
    function b(t) {
        ...
        if (t.dataset) {
            ...
            for (var i = Object.keys(n).sort(function(t, e) { return parseInt(t, 10) < parseInt(e, 10) ? -1 : 1 }), a = window.innerWidth * window.devicePixelRatio, l = 0; l < i.length - 1 && i[l] < a;) l++;
            e = n[i[l]] || e
        }
        return e
    }

    function p() { var t; return M <= V.length - 2 ? (M++, y(), k(M), t = !0) : Y.animation && (A.className = "bounce-from-right", setTimeout(function() { A.className = "" }, 400), t = !1), Y.onChange && Y.onChange(M, V.length), t }

    function h() { var t; return M >= 1 ? (M--, y(), C(M), t = !0) : Y.animation && (A.className = "bounce-from-left", setTimeout(function() { A.className = "" }, 400), t = !1), Y.onChange && Y.onChange(M, V.length), t }

    function y() { var t = 100 * -M + "%"; "fadeIn" === Y.animation ? (A.style.opacity = 0, setTimeout(function() { j.transforms ? A.style.transform = A.style.webkitTransform = "translate3d(" + t + ",0,0)" : A.style.left = t, A.style.opacity = 1 }, 400)) : j.transforms ? A.style.transform = A.style.webkitTransform = "translate3d(" + t + ",0,0)" : A.style.left = t }

    function v() { var t = T("div"); return "undefined" != typeof t.style.perspective || "undefined" != typeof t.style.webkitPerspective }

    function w() { var t = T("div"); return t.innerHTML = "<svg/>", "http://www.w3.org/2000/svg" === (t.firstChild && t.firstChild.namespaceURI) }

    function k(t) { t - M >= Y.preload || m(t + 1, function() { k(t + 1) }) }

    function C(t) { M - t >= Y.preload || m(t - 1, function() { C(t - 1) }) }
    ...
    function E(t, e, n, o) { t.removeEventListener ? t.removeEventListener(e, n, o) : t.detachEvent("on" + e, n) }

    function B(t) { return document.getElementById(t) }
    ...
    var N, A, L, S, P, F = '<svg width="44" height="60"><polyline points="30 10 10 30 30 50" stroke="rgba(255,255,255,0.5)" stroke-width="4"stroke-linecap="butt" fill="none" stroke-linejoin="round"/></svg>',
        ...
        V = [],
        U = null,
        W = function(t) {-1 !== t.target.id.indexOf("baguette-img") && g() },
        G = function(t) { t.stopPropagation ? t.stopPropagation() : t.cancelBubble = !0, h() },
        J = function(t) { t.stopPropagation ? t.stopPropagation() : t.cancelBubble = !0, p() },
        K = function(t) { t.stopPropagation ? t.stopPropagation() : t.cancelBubble = !0, g() },
        Q = function(t) { R.count++, R.count > 1 && (R.multitouch = !0), R.startX = t.changedTouches[0].pageX, R.startY = t.changedTouches[0].pageY },
        Z = function(t) {
            if (!O && !R.multitouch) {
        ...
        $ = function() { R.count--, R.count <= 0 && (R.multitouch = !1), O = !1 },
        _ = function() { $() },
        tt = function(t) { "block" === N.style.display && N.contains && !N.contains(t.target) && (t.stopPropagation(), c()) };
    return [].forEach || (Array.prototype.forEach = function(t, e) { for (var n = 0; n < this.length; n++) t.call(e, this[n], n, this) }), [].filter || (Array.prototype.filter = function(t, e, n, o, i) { for (n = this, o = [], i = 0; i < n.length; i++) t.call(e, n[i], i, n) && o.push(n[i]); return o }), { run: function(e, i) { j.transforms = v(), j.svg = w(), o(), n(e), t(e, i) }, showNext: p, showPrevious: h, destroy: function() { l(), e(), E(document, "keydown", i), document.getElementsByTagName("body")[0].removeChild(document.getElementById("baguetteBox-overlay")), D = {}, X = [], M = 0 } }
});
(function() {
    Array.prototype.CSSClassIndexOf = Array.prototype.indexOf || function(a) {
        for (var b = this.length, e = 0; e < b; e++)
            if (this[e] === a) return e;
        return -1
    };
    var d = "classList" in document.createElement("a"),
        c = Element.prototype;
    d ? (c.hasClass || (c.hasClass = function(a) {
        var b = !0;
        Array.prototype.slice.call(this.classList);
        a = a.split(" ");
        for (var e = 0; e < a.length; e++) this.classList.contains(a[e]) || (b = !1);
        return b
    }), c.addClass || (c.addClass = function(a) {
        a = a.split(" ");
        for (var b = 0; b < a.length; b++) this.hasClass(a[b]) || this.classList.add(a[b]);
        return this
    }), c.removeClass || (c.removeClass = function(a) {
        this.className.split(" ");
        a = a.split(" ");
        for (var b = 0; b < a.length; b++) this.hasClass(a[b]) && this.classList.remove(a[b]);
        return this
    }), c.toggleClass || (c.toggleClass = function(a) { a = a.split(" "); for (var b = 0; b < a.length; b++) this.classList.toggle(a[b]); return this })) : (c.hasClass || (c.hasClass = function(a) {
        var b = !0,
            e = this.className.split(" ");
        a = a.split(" ");
        for (var c = 0; c < a.length; c++) - 1 === e.CSSClassIndexOf(a[c]) && (b = !1);
        return b
    }), c.addClass || (c.addClass =
        function(a) { a = a.split(" "); for (var b = 0; b < a.length; b++) this.hasClass(a[b]) || (this.className = "" !== this.className ? this.className + " " + a[b] : a[b]); return this }), c.removeClass || (c.removeClass = function(a) {
        var b = this.className.split(" ");
        a = a.split(" ");
        for (var c = 0; c < a.length; c++) this.hasClass(a[c]) && b.splice(b.CSSClassIndexOf(a[c]), 1);
        this.className = b.join(" ");
        return this
    }), c.toggleClass || (c.toggleClass = function(a) {
        a = a.split(" ");
        for (var b = 0; b < a.length; b++) this.hasClass(a[b]) ? this.removeClass(a[b]) : this.addClass(a[b]);
        return this
    }));
    d = NodeList.prototype;
    d.hasClass || (d.hasClass = function(a, b) {
        void 0 === b && (b = !0);
        for (var c = 0, d = b ? !0 : !1;
            (b && !0 === d || !b && !1 === d) && c < this.length; ++c) d = this[c].hasClass(a);
        return d
    });
    d.addClass || (d.addClass = function(a) { for (var b = 0; b < this.length; ++b) this[b].addClass(a) });
    d.removeClass || (d.removeClass = function(a) { for (var b = 0; b < this.length; ++b) this[b].removeClass(a) });
    d.toggleClass || (d.toggleClass = function(a) { for (var b = 0; b < this.length; ++b) this[b].toggleClass(a) })
})();

/* ---------------------------------------------------- */
/*                   CLOSEST POLYFILL                   */
/* -----------------------------------------------------*/
// https://www.snip2code.com/Snippet/964738/closest()-polyfill
...
// From : https://gist.github.com/cferdinandi/a9e76e3fcf3272a35c9ac6712f491d9d

if (!Object.prototype.forEachLoop) {
...
function toggle(param) {
    var toggleElement = document.querySelector('.' + param);
    toggleElement.toggleClass('active');
}

/* Sticky */
function handleScrollStickyHeader(event) {
    var toggleElement = document.querySelector('.header');

    if (document.body.clientWidth > 1279) {
        if (document.body.scrollTop > 60 || document.documentElement.scrollTop > 60) {
            toggleElement.addClass('sticky');
        } else {
            toggleElement.removeClass('sticky');
        }
    }
    if (document.body.clientWidth < 1279) {
...
// handles scroll to the top of the lists
function scrollToListTop() {
    document.getElementById('tabsBlock').scrollIntoView();
    window.scroll(0, window.scrollY - document.querySelector('.header').scrollHeight);
}

function handleScrollStickySocial(event) {
    var toggleElement = document.querySelector('.sharesShortcuts');
    var scrollTopLink = toggleElement.querySelector('.scrollTop');

    if (document.body.clientWidth > 1279) {
        if (document.body.scrollTop > 510 || document.documentElement.scrollTop > 510) {
            toggleElement.classList.add('sticky');
            scrollTopLink.style.display = "flex";
        } else {
...
var pageDescriptionMenu = null, // will be set to the page description menu dom element on dom ready 
    pageDescriptionMenuTop = 0; // same, distance from the top of the screen 

// handles the sticky position of the page sub menu 
function handleScrollStickyMenu(event) {
    if (pageDescriptionMenu && window.innerWidth >= 978) {
        if (document.body.scrollTop > pageDescriptionMenuTop || document.documentElement.scrollTop > pageDescriptionMenuTop) {
            pageDescriptionMenu.classList.add("sticky");
        } else {
            pageDescriptionMenu.classList.remove("sticky");
        }
    }
}

window.addEventListener('scroll', this.handleScrollStickyHeader);
window.addEventListener('scroll', this.handleScrollStickySocial);


/* ---------------------------------------------------- */
/*     ON CLICK HANDLERS (With active class watcher)    */
/* -----------------------------------------------------*/

// List of element needing an active class watch

let dropDownsMenuMobile = Array.from(document.querySelectorAll(".js-toggleSubMenuMobile"));
let dropDownsMenuDesktop = Array.from(document.querySelectorAll(".js-toggleSubMenuDesktop"));
let dropDownsMenuLanguage = Array.from(document.querySelectorAll(".js-toggleLanguageMenu"));

let toggleLanguageSelect = Array.from(document.querySelectorAll(".js-toggleLanguageSelect"));
let toggleSearch = Array.from(document.querySelectorAll(".js-toggleSearch"));

let toggleMenuMobile = Array.from(document.querySelectorAll(".js-toggleMenuMobile"));
var menuMobile = document.querySelector(".js-MenuMobile");

let toggleDispatchMenu = Array.from(document.querySelectorAll(".js-toggleDispatchMenu"));

let toggleFilters = Array.from(document.querySelectorAll(".js-toggleFilters"));

// Readmore 
let toggleReadMore = Array.from(document.querySelectorAll(".js-toggleReadMore"));
// var ReadMoreWrapper = Array.from(document.querySelectorAll(".js-ReadMore"));

/* ---------------------------------------------------- */
/*            Active class watchers calls               */
/* -----------------------------------------------------*/

enableActiveClassWatcher(dropDownsMenuMobile, "self");
enableActiveClassWatcher(dropDownsMenuDesktop, "parent");
enableActiveClassWatcher(dropDownsMenuLanguage, "next");
enableActiveClassWatcher(toggleSearch, "next");
enableActiveClassWatcher(toggleMenuMobile, "self");
enableActiveClassWatcher(toggleMenuMobile, "elsewhere", menuMobile);
enableActiveClassWatcher(toggleDispatchMenu, "self");
enableActiveClassWatcher(toggleFilters, "self");
enableActiveClassWatcher(toggleReadMore);

/* ---------------------------------------------------- */
/*            Active class watchers function            */
/* -----------------------------------------------------*/

/* Active class watcher function */
function enableActiveClassWatcher(list, mode, elementTarget) {
    // Follow active class watch on parent's class
    if (mode === "parent") {
        function handleClick(e) {
            // e.preventDefault();
            var alreadyClicked = e.currentTarget.parentNode.classList.contains('active');
            dropDownsMenuDesktop.forEach(function(node) {
    ...
    // Follow active class watch on elements with same class
    else if (mode === "self") {
        if (list) {
            function handleClick(e) {
                // e.preventDefault();
                var alreadyClicked = e.currentTarget.classList.contains('active');
    ...
    // Follow active class watch on elements with same class
        ...
        function handleClick(e) {
            // e.preventDefault();
            var alreadyClicked = e.currentTarget.nextElementSibling.classList.contains('active');
            list.forEach(function(node) {
                node.classList.remove('active');
                node.nextElementSibling.classList.remove("js-active");
            });
            if (!alreadyClicked) {
    ...
    // If the target to toggle is elsewhere in the DOM (specifying target)
    else if (mode === "elsewhere") {

        function handleClick(e) {
            // e.preventDefault();
            var alreadyClicked = elementTarget.classList.contains('active');
            list.forEach(function(node) {
    ...
    // If the target to toggle is the ReadMore block (yes, it's ugly)
    else {

        function handleClick(e) {
            // e.preventDefault();
            var parentElement = e.currentTarget.closest('.js-ReadMore');
            var alreadyClicked = parentElement.classList.contains('active');
            if (!alreadyClicked) {
...
sliders.forEach(function(node, i) {
    node.addClass('slider-' + (i + 1));
    var currentId = node.querySelector('.swiper-pagination-current');
    var total = node.querySelector('.swiper-pagination-total');

    var mySwiper = new Swiper('.slider-' + (i + 1) + ' .swiper-container', {
        // Optional parameters
        direction: 'horizontal',

        // Navigation arrows
        navigation: {
            nextEl: '.slider-' + (i + 1) + ' .swiper-button-next',
            prevEl: '.slider-' + (i + 1) + ' .swiper-button-prev'
        }
    });

    currentId.innerHTML = mySwiper.activeIndex + 1;
    total.innerHTML = mySwiper.slides.length;
...
/* Home True / False Slider */
function buildSlider() {

    // Check if "quiz" exists
    if (document.querySelector(".quiz")) {

        // Get width of the container of the Slider
        let widthOfSlider = document.querySelector(".quiz__container").offsetWidth;

        // Set offset width for slider
        let offsetSlider = 0;

        // Select the quizcard slider 
        sliderQuizCards = document.querySelector(".js-quizcards");
        // Select all the quizcards
        let allQuizCards = Array.from(document.querySelectorAll(".js-quizcard"));

        // Count the number of slide cards and set width of container based on the number of cards
        let sliderQuizCardsWidth = (widthOfSlider * allQuizCards.length);
        sliderQuizCards.style.width = sliderQuizCardsWidth + "px";

        // Set all quizcards width depending on width of container
        allQuizCards.forEach(function(quizcard) {
            quizcard.style.width = widthOfSlider + "px";
        });

        // Set all buttons to slide the container by its width
        let allQuizButtons = Array.from(document.querySelectorAll(".js-quizcard .btn"));
        allQuizButtons.forEach(function(button) {
            button.addEventListener('click', function() {
                offsetSlider = offsetSlider - widthOfSlider;
                if (offsetSlider > -sliderQuizCardsWidth) {
                    sliderQuizCards.style.marginLeft = offsetSlider + "px";
                }
            });
        });
    }
...
/* Home Twitter Feed integration */
function resizeTwitter() {

    // Check if feed container exists
    if (document.querySelector('.TwitterThread')) {

        // Build the style tag
        var style = document.createElement("style");
        style.innerHTML = ".timeline-Tweet-text { font-size: 15px !important;line-height: 20px !important;font-weight: 300;}";
        style.type = "text/css";

        // Inject it in the widget
        var widget = document.getElementById("twitter-widget-0").contentDocument;
        widget.head.appendChild(style);
    }
    return false;
}

/** gets the position from top-left corner of the page of an element @param {HTMLElement} element */
...
// Load slider & resize twitter feed integration on document ready
...
// When window is resized, reload the slider after 0.5s
window.addEventListener("resize", function() {
    if (typeof sliderQuizCards !== 'undefined') {
        setTimeout(function() {
            sliderQuizCards.style.marginLeft = "0px";
            buildSlider();
        }, 500);
    }
});
...
/* ------------------------------------------------------------------------- */
/*  Disable certain active classes when clicking on specific other elements  */
/* ------------------------------------------------------------------------- */

toggleMenuMobile[0].addEventListener('click', function() {
    dropDownsMenuLanguage[0].nextElementSibling.classList.remove('active');
    toggleSearch[0].nextElementSibling.classList.remove('active');
});

dropDownsMenuLanguage[0].addEventListener('click', function() {
    toggleMenuMobile[0].classList.remove('active');
...
toggleSearch[0].addEventListener('click', function() {
    toggleMenuMobile[0].classList.remove('active');
    menuMobile.classList.remove('active');
    dropDownsMenuLanguage[0].nextElementSibling.classList.remove('active');
    dropDownsMenuDesktop.forEach(function(node) {
...
toggleLanguageSelect.forEach(function(node) {
...
/* ---------------------- */
/*  Panels with plain JS  */
/* ---------------------- */

let tabsList = Array.from(document.querySelectorAll('.js-tabsList'));
let containerList = Array.from(document.querySelectorAll('.tab-content section.tab-container'));
...
domReady(function() {
    ...
    if (tabsList.length > 0 && document.URL.split('#').length > 1 && document.URL.split('#')[1].length > 0) {
        var thisTab = document.URL.split('#')[1];

        // Just in case : remove all active classes on both tabs and containers
        tabsList.forEach(function(node) {
            node.classList.remove('active');
        });
        containerList.forEach(function(node) {
            node.classList.remove('active');
        });

        // Add active class based on Url Query
        if (document.querySelector("#" + thisTab) !== null && document.querySelector("#tab--" + thisTab) !== null) {
    ...
    // Standard behavior for tabs (On tab clicks)
    tabsList.forEach(function(node, i) {
        node.addEventListener('click', function() {
            tabsList.forEach(function(node) {
                node.classList.remove('active');
            });
    ...
    // JS image gallery using baguetteBox.js
    baguetteBox.run('.js-gallery');

    // JS anchors generation for wysiwyg
    var wysiwygContainer = document.querySelector(".container .ezrichtext-field");
    var overviewContainer = document.querySelector(".overview .overview__container");
    if (overviewContainer !== null && wysiwygContainer !== null) {
        getWysiwygHeaders(wysiwygContainer, overviewContainer);
        // Hiding overview if there is 0 or 1 link
        if (overviewContainer.querySelector('ul.overview__list').children.length <= 1) {
            document.querySelector(".overview").addClass('hidden');
        }
    }

    // Dispatch menu mobile select
    var dispatchMenu = document.querySelector(".pageDescription--withMenu__menu__mobile .generalForm__selectArea");
    if (dispatchMenu !== null) {
        dispatchMenu.addEventListener('change', function(e) {
            location = e.target.value;
        }, false);
    }

    // the content page menu stickyness
    pageDescriptionMenu = document.querySelector(".pageDescription--withMenu__menu");
    if (pageDescriptionMenu) {
        pageDescriptionMenuTop = getPosition(pageDescriptionMenu).y - document.querySelector(".header").getBoundingClientRect().height + 7;
        handleScrollStickyMenu();
        window.addEventListener('scroll', handleScrollStickyMenu);
    }

});

/* ---------------------------------------------------- */
/*            CLOSE ALL WHEN OUTSIDE HEADER             */
/* -----------------------------------------------------*/
...
containerList.forEach(function(node) {
    ...
    node.addEventListener('click', function(e) {
        ...
        if (element.matches('section.tab-container .counter a, section.tab-container .counter a *')) {
            e.preventDefault();
            if (!element.dataset.disabled) {
                getAjax(element.closest('a').href, function(data) {
                    node.closest('section.tab-container').innerHTML = data;
                    baguetteBox.run('.js-gallery');
                    scrollToListTop();
                });
            }
    ...
    // On change on filters selects
    node.addEventListener('change', function(e) {
        var element = e.target;
        if (element.matches('section.tab-container select')) {
            e.preventDefault();
            var container = node.closest('section.tab-container');
            var url = container.dataset.url + getFiltersUrlParameters(container);
            getAjax(url, function(data) {
                container.innerHTML = data;
                baguetteBox.run('.js-gallery');

                /*var called_url = container.dataset.url.split('/');
                console.log(container.dataset.url);
                called_url.pop();
                called_url.shift();
                called_url.shift();
                called_url.shift();
                var new_url = called_url.join('/');
                console.log(getFiltersUrlParameters(container));
                new_url = new_url + getFiltersUrlParameters(container);
                console.log(new_url);
                new_url = new_url.concat((document.URL.split('#').length > 1) ? '#'+document.URL.split('#')[1] : '');
                console.log(new_url);
                history.pushState({id: data.id}, null, new_url);*/
            });
        }
    }, false);
});
...
// search page
let searchPageContainer = document.querySelector('.searchPage .search__resultsBlock--wrapper');
let searchPageForm = document.querySelector('form.search__inputBlock--actions');
if (searchPageContainer !== null) {
    // On change on filters selects
    searchPageContainer.addEventListener('change', function(e) {
        var element = e.target;
        if (element.matches('.filters__wrapper select')) {
            e.preventDefault();
            var url = searchPageForm.action + getFiltersUrlParameters(searchPageContainer);
            url += '&search=' + searchPageForm.querySelector('input').value;
            getAjax(url + '&dynam=1', function(data) {
                searchPageContainer.innerHTML = data;
                baguetteBox.run('.js-gallery');
                window.history.pushState(window.location.href, document.title, url);
            });
        }
    }, false);
    // On click on pagination links
    searchPageContainer.addEventListener('click', function(e) {
        var element = e.target;
...
// Building url parameters from filters
function getFiltersUrlParameters(container) {
    let filterList = Array.from(container.querySelectorAll('select'));
    var params = '?';
    filterList.forEach(function(node) {
        params = params + "&" + node.getAttribute('name') + "=" + node.options[node.selectedIndex].value;
    });
    return params;
}

/* ---------------------------------------------------- */
/*                BUILDING ANCHORS BLOCK                */
/* -----------------------------------------------------*/

// Getting all the headers (3 first levels) in the wysiwyg and adding ids to them
function getWysiwygHeaders(wysiwygContainer, overviewContainer) {
    var headers = Array.from(wysiwygContainer.querySelectorAll("h1, h2, h3"));
    var anchorList = overviewContainer.querySelector('ul.overview__list');

    headers.forEach(function(node, i) {
        node.id = "pt-" + (i + 1);
        buildAnchor(anchorList, node.innerHTML, i);
    });
}

// Building on anchor link in the overview block
function buildAnchor(anchorList, anchorText, i) {
    // Building the link & text
    var anchorLink = document.createElement('a');
    anchorLink.href = "#pt-" + (i + 1);
    anchorLink.appendChild(document.createTextNode(anchorText));

    // Building the structure
    var anchor = document.createElement('li');
    anchor.addClass('overview__listItem');
    anchor.appendChild(anchorLink);

    // Appending to the anchor list
...
function postAjax(url, serializedData, success) {
    var xhr = window.XMLHttpRequest ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
    xhr.open('POST', url);
    xhr.onreadystatechange = function() {
        if (xhr.readyState > 3 && xhr.status == 200) success(xhr.responseText);
